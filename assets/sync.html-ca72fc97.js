import{_ as e,W as t,X as s,a0 as c,Y as n}from"./framework-bcad4379.js";const o={},l=n("div",{class:"custom-container warning"},[n("p",{class:"custom-container-title"},"注意"),n("p",null,"此功能时实验性的"),n("p",null,"由于同步传输时的数据是明文传输，请在受信任的网络下使用此功能！")],-1),a=n("p",null,"PCv2测试版同步功能暂未开发完成",-1),P=n("p",null,"请使用列表备份进行导出",-1);function _(r,C){return t(),s("div",null,[l,a,P,c(` 此功能需要配合移动端使用，PC 端与移动端处在同一个局域网（路由器的网络）下时，可以多端实时同步歌曲列表，使用方法：
...
3.  若移动端无法打开第 2 步的地址，则在 PC 端的浏览器地址栏输入并打开该地址，若可以打开，则要么是被 LX Music PC 端被电脑
    防火墙拦截，要 么 PC 端与移动端不在同一个网络下，或者路由器开启了 AP 隔离（一般在公共网络下会出现这种情况） `)])}const u=e(o,[["render",_],["__file","sync.html.vue"]]);export{u as default};
